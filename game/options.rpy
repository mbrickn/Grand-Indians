...
init -1 python hide:
    ...
    config.window_title = u"GRAND INDIANS"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "MechaWahoo"
    config.version = "0.2"
    ...
    style.default.font = "fonts/league_gothic/LeagueGothic-Regular.otf"
    ...
    config.main_menu_music = "audio/tribe.ogg"
    ...
    config.end_splash_transition = vpunch
...
python early:
    config.save_directory = "MechaWahoo-1463009321"
